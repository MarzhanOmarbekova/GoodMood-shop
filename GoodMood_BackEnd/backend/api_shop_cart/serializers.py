...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    """
    cart_item_id = serializers.IntegerField(source='id', read_only=True)  # Rename 'id' to 'cart_item_id'
...
class CartSerializer(serializers.ModelSerializer):
    ...
    """
    cart_id = serializers.IntegerField(source='id', read_only=True)  # Rename 'id' to 'cart_id'
