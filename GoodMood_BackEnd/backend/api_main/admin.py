...
class ProductAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ('categories',)  # Horizontal widget for managing many-to-many categories
...
class SizeAdmin(admin.ModelAdmin):
    list_display = ('name', 'description', 'created_at')  # Display fields in the list view
